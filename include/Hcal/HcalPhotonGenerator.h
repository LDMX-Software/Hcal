#ifndef HcalPhotonGenerator_h
#define HcalPhotonGenerator_h
...
class HcalPhotonGenerator
{
  public:

    HcalPhotonGenerator(CLHEP::RandFlat &randFlat, CLHEP::RandGaussQ &randGaussQ, CLHEP::RandPoissonQ &randPoissonQ) :
