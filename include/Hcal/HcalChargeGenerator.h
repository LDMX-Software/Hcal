...
#ifndef HcalChargeGenerator_hh
#define HcalChargeGenerator_hh
...
namespace hcal
{
  ...
  class HcalChargeGenerator
  {
    ...
    HcalChargeGenerator(CLHEP::RandFlat &randFlat, CLHEP::RandPoissonQ &randPoissonQ, const std::string &photonMapFileName);
    ~HcalChargeGenerator() {_photonMapFile->Close();}
