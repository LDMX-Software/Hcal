...
class HcalHgcrocEmulator(HgcrocEmulator) :
    ...
    def __init__(self) :
        ...
        self.readoutPadCapacitance = 20. # pF

        # pedestal
        self.pedestal = pedestal

        # readout threshold (cut hits below one PE)
        self.readoutThreshold = self.pedestal+4
        ...
        self.timePeak    = 9.747
        self.measTime    = self.clockCycle/2.
    ...
    def setThresholdDefaults(self, pePerMIP):
        ...
        #self.toaThreshold = self.gain*self.pedestal + self.calculateVoltageHcal(0.05*pePerMIP)
        self.toaThreshold = self.gain*self.pedestal + self.calculateVoltageHcal(1)
